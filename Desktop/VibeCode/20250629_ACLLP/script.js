...
function initCountdown() {
    // 募集開始日時: 2025年7月1日 20:00 (JST)
    const targetDate = new Date('2025-07-01T20:00:00+09:00').getTime();
...
function initAnimations() {
    ...
    // アニメーション対象の要素を監視
    const animateElements = document.querySelectorAll('.problem-item, .feature-item, .benefit-item, .event-item, .faq-item');
